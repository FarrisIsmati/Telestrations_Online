...
// Wouldn't you consider this component a `Main` component and store it in that directory
// since it represents a primary view?
class About extends Component {
  ...
  render() {
    return (
      <div>
        <div className='Rules'>
        // generally, don't capitalize classNames unless they mirror component names
          <h2> How to play: </h2>
          <ul>
